...
namespace Wodsoft.Protobuf.Generators
{
    ...
    public class UInt64CodeGenerator : StructureCodeGenerator<ulong>
    {
        ...
        public override void GenerateCalculateSizeCode(ILGenerator ilGenerator, LocalBuilder valueVariable)
        {
            ...
            ilGenerator.Emit(OpCodes.Call, typeof(CodedOutputStream).GetMethod(nameof(CodedOutputStream.ComputeUInt64Size), BindingFlags.Static | BindingFlags.Public, null, new Type[] { typeof(ulong) }, null));
        }
        ...
        public override void GenerateReadCode(ILGenerator ilGenerator)
        {
            ...
            ilGenerator.Emit(OpCodes.Call, typeof(ParseContext).GetMethod(nameof(ParseContext.ReadUInt64), Array.Empty<Type>()));
        }
        ...
        public override void GenerateWriteValueCode(ILGenerator ilGenerator, LocalBuilder valueVariable)
        {
            ...
            ilGenerator.Emit(OpCodes.Ldarg_1);
            ilGenerator.Emit(OpCodes.Ldloc, valueVariable);
            ilGenerator.Emit(OpCodes.Call, typeof(WriteContext).GetMethod(nameof(WriteContext.WriteUInt64), new Type[] { typeof(ulong) }));
        }
    }
}
